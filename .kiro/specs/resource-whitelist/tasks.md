...
- [ ] 1. 型定義とドメインマッチング関数の実装
  - [ ] 1.1 ExternalResourceConfig 型と DEFAULT_ALLOWED_DOMAINS を定義する
    - `src/types/models.ts` に `ExternalResourceMode` 型、`ExternalResourceConfig` インターフェース、`DEFAULT_ALLOWED_DOMAINS` 定数を追加する
    - _Requirements: 1.1, 1.5_

  - [ ] 1.2 extractDomain() と isDomainAllowed() を実装する
  ...
  - [ ]* 1.3 extractDomain と isDomainAllowed のプロパティテストを作成する
  ...
  - [ ]* 1.4 extractDomain と isDomainAllowed のユニットテストを作成する
...
- [ ] 2. filterExternalResources の実装
  - [ ] 2.1 filterExternalResources() 関数を実装する
  ...
  - [ ]* 2.2 filterExternalResources のプロパティテストを作成する
  ...
  - [ ]* 2.3 filterExternalResources のユニットテストを作成する
...
- [ ] 4. 設定解決と package.json の更新
  - [ ] 4.1 resolveExternalResourceConfig() を実装し getConfig() を更新する
  ...
  - [ ] 4.2 package.json に新しい設定スキーマを追加する
  ...
  - [ ]* 4.3 resolveExternalResourceConfig のプロパティテストを作成する
    - **Property 8: 新設定の優先**
    - **Validates: Requirement 4.3**

  - [ ]* 4.4 resolveExternalResourceConfig のユニットテストを作成する
    - レガシー設定のみ、新設定のみ、両方存在、どちらも未設定の各パターンをテスト
    - _Requirements: 1.2, 1.3, 1.4, 1.5, 4.1, 4.2, 4.3, 4.4_

- [ ] 5. 既存コードの統合
  - [ ] 5.1 renderMarkdownDocument を filterExternalResources に切り替える
